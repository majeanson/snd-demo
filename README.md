...
1. **Rev 01 — barebones**: home page with the name. ← *current*
2. **Rev 02 — first feature**: voice clip playback + transcript reveal
3. **Rev 03 — improvements**: parser pulls out materials + hours
4. **Rev 04 — final feature**: invoice draft renders inline
